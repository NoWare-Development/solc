...
bool Type::is_explicit_pointer() const
{
...
const std::vector<size_t> &Type::get_array_sizes() const
{
  return array_sizes;
}

size_t Type::get_pointer_indirection() const
{
  return pointer_indirection;
}

size_t Type::get_full_pointer_indirection() const
{
  return pointer_indirection + array_sizes.size();
}

Symbol *Type::get_symbol_binding() const
{
  return symbol_binding;
}

const std::shared_ptr<Type> &Type::get_return_type() const
{
  return return_type;
}

const std::vector<Type::FuncArg> &Type::get_function_arguments() const
{
  return arguments;
}
