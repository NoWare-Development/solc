...
enum struct ASTType : uint16_t
{
  ...
  FUNC_DECL = __AST_DEF (ASTGroup::FUNC, 1),
  FUNC_DEF = __AST_DEF (ASTGroup::FUNC, 2),
  FUNC_ARGLIST = __AST_DEF (ASTGroup::FUNC, 3),
  ...
  INITLIST_ENTRY_INIT = __AST_DEF (ASTGroup::INITLIST_ENTRY, 0),
  INITLIST_ENTRY_INIT_EXPLICIT = __AST_DEF (ASTGroup::INITLIST_ENTRY, 1),
  INITLIST_ENTRY_INIT_EXPLICIT_TARGET
  = __AST_DEF (ASTGroup::INITLIST_ENTRY, 2),
};
#undef __AST_DEF
