...
enum struct ASTType : uint16_t {
  ...
  TYPE_TYPEOF = __AST_DEF(ASTGroup::TYPE, 4),
  ...
  EXPR_COMPARE_OPERATOR_LTHANEQ = __AST_DEF(ASTGroup::EXPR_COMPARE_OPERATOR, 4),
  EXPR_COMPARE_OPERATOR_GTHANEQ = __AST_DEF(ASTGroup::EXPR_COMPARE_OPERATOR, 5),
  ...
  // NOTE: This AST type should only be used when parsing expressions,
  // just to identify that previous AST is an operator.
  EXPR_OPERAND_VOID = __AST_DEF(ASTGroup::EXPR_OPERAND, 0),

  EXPR_OPERAND_IDENTIFIER = __AST_DEF(ASTGroup::EXPR_OPERAND, 1),
  EXPR_OPERAND_NUM = __AST_DEF(ASTGroup::EXPR_OPERAND, 2),
  EXPR_OPERAND_NUMFLOAT = __AST_DEF(ASTGroup::EXPR_OPERAND, 3),
  EXPR_OPERAND_ARRAY_ELEMENT = __AST_DEF(ASTGroup::EXPR_OPERAND, 4),
  EXPR_OPERAND_CAST_TO = __AST_DEF(ASTGroup::EXPR_OPERAND, 5),
  EXPR_OPERAND_CALL = __AST_DEF(ASTGroup::EXPR_OPERAND, 6),
  EXPR_OPERAND_NUMTYPESPEC = __AST_DEF(ASTGroup::EXPR_OPERAND, 7),
  EXPR_OPERAND_STRING = __AST_DEF(ASTGroup::EXPR_OPERAND, 8),
  EXPR_OPERAND_SYMBOL = __AST_DEF(ASTGroup::EXPR_OPERAND, 9),
  EXPR_OPERAND_ACCESS_MEMBER = __AST_DEF(ASTGroup::EXPR_OPERAND, 10),
  EXPR_OPERAND_GENERIC_CALL = __AST_DEF(ASTGroup::EXPR_OPERAND, 11),
  EXPR_OPERAND_SIZEOF = __AST_DEF(ASTGroup::EXPR_OPERAND, 12),
  ...
  GENERIC_FUNC = __AST_DEF(ASTGroup::GENERIC, 1),
  GENERIC_PLACEHOLDER_TYPE_LIST = __AST_DEF(ASTGroup::GENERIC, 2),
  GENERIC_PLACEHOLDER_TYPE = __AST_DEF(ASTGroup::GENERIC, 3),
