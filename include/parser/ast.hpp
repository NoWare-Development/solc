...
enum struct ASTType : uint16_t {
  ...
  STRUCT = __AST_DEF(ASTGroup::NONE, 11),
  UNION = __AST_DEF(ASTGroup::NONE, 12),
  ENUM = __AST_DEF(ASTGroup::NONE, 13),
  FUNC = __AST_DEF(ASTGroup::NONE, 14),
  NAMESPACE = __AST_DEF(ASTGroup::NONE, 15),
  INITLIST = __AST_DEF(ASTGroup::NONE, 16),
  PREFIX_EXPR = __AST_DEF(ASTGroup::NONE, 17),
  GENERIC = __AST_DEF(ASTGroup::NONE, 18),
